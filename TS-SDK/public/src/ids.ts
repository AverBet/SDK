...
export const AVER_PROGRAM_ID = new PublicKey('6q5ZGhEj6kkmEjuyCXuH4x8493bpi9fNzvy9L8hX83HQ')
export const AVER_TOKEN = new PublicKey('AVERsCxn9wr9YZ4WVavPbjm13hrLTPAkdnu1QqK9ZL1y')
export const AVER_MARKET_AUTHORITY = new PublicKey('EEg375Q8wEsPTyaQ4jG4hmNsMojmMHs6gB58iVWUXSwF')
export const AVER_HOST_ACCOUNT = new PublicKey('5xhmqK1Dh48TiqvHxoZi6WWWKL6THtsUjh3GoiVEbbR8')
...
export const USDC_DEVNET = new PublicKey('BWvbxUTAxevm1NG8RHe1LhKmca9nz5ym2xqafTxr6ybj')
...
export const USDC_MAINNET = new PublicKey('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v') // (USDC)
...
export const getAverApiEndpoint = (solanaNetwork: SolanaNetwork) =>
  solanaNetwork == SolanaNetwork.Devnet ? AVER_API_ENDPOINT_DEVNET : AVER_API_ENDPOINT_MAINNET
export const getSolanaEndpoint = (solanaNetwork: SolanaNetwork) =>
  solanaNetwork == SolanaNetwork.Devnet ? SOLANA_ENDPOINT_DEVNET : SOLANA_ENDPOINT_MAINNET
