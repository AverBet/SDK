...
export declare class AverClient {
     ...
     */
    static loadAverClient(connection: Connection, solanaNetwork: SolanaNetwork, owner: Wallet | Keypair, opts?: ConfirmOptions, averProgramId?: PublicKey): Promise<AverClient | null>;
